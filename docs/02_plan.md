...
**핵심 발견 (E108)**: au_bias 약화가 이득 — ×0.7 0.77374(+0.0005) > ×1.0 0.77326 > ×1.3 0.77227. 단조 추세라 **×0.5/×0.3 스윕 중**(생성 완료 시 제출해 최적점 확정). au_bias 강도가 모델 세대 종속.
...
5. ✅ au 프로브 ×0.7/×1.3 제출 → **×0.7 = 0.77374 신최고** (au07), ×1.3 악화. **×0.5/×0.3 스윕 진행**(생성 후 제출)
6. **현 확정 최종 후보 = submit_distill_au07.zip 0.77374.** 7/15 아침 최고 LB zip 선택 확인
