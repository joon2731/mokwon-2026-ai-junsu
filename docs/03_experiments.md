...
| E103 | 07-13 | 0.6B full-data **OOF 다중교사 증류** (teacher=Qwen3×XLM-R OOF 블렌드 0.7735, T=3, α=0.6) | V2 | (홀드아웃 없음) | **0.77264** 🏆 | 841MB | | **+0.0014 vs E100. 앙상블 지식의 단일 모델 압축 실증. 현 기준선** |
...
### E105 — 3-way 교사 재증류 + BSM 게이트 (07-13 밤 체인, 07-14 아침 판정)
- 슬롯 A: 3-way 교사(0.7754) 재증류 full-data **완주** → 프루닝(로짓 동치)·패키징·드라이런 통과, `da2\submit_distill3w.zip` (841MB). LB 결과 대기
